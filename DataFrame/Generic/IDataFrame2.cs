...
namespace DataFrame.Generic
{
    public interface IDataFrame<TIndex1, TIndex2>
    {
        ...
        public IDataFrame<TIndex1, TIndex2> this[TIndex1 rowIndex1, IEnumerable<TIndex2> rowIndices2] { get; }
        public IDataFrame<TIndex1, TIndex2> this[IEnumerable<TIndex1> rowIndices1, TIndex2 rowIndex2] { get; }
