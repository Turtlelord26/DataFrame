...
namespace DataFrame.SeriesCollection
{
                                                              ...
                                                              where T : IIndexLabel
    {
        ...
        public IDataFrame<T> this[IEnumerable<IIndexLabel> rowIndices, IEnumerable<string> seriesNames] { get; }
        ...
        public IDataFrame<T> this[Func<IIndexLabel, bool> rowIndexFilter, IEnumerable<string> seriesNames] { get; }
        ...
        public IDataFrame<T> this[IEnumerable<IIndexLabel> rowIndices, IEnumerable<KeyValuePair<string, bool>> seriesNameFilter] { get; }
        ...
        public IDataFrame<T> this[Func<IIndexLabel, bool> rowIndexFilter, IEnumerable<KeyValuePair<string, bool>> seriesNameFilter] { get; }
        ...
        public IDataFrame<T> this[IEnumerable<IIndexLabel> rowIndices, Func<string, bool> seriesNameFilter] { get; }
        ...
        public IDataFrame<T> this[Func<IIndexLabel, bool> rowIndexFilter, Func<string, bool> seriesNameFilter] { get; }
